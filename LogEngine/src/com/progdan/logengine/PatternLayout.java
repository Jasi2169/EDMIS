...
import com.progdan.logengine.helpers.PatternParser;
import com.progdan.logengine.helpers.PatternConverter;
...
/**
   ...
   that the logengine environment was set to use a PatternLayout. Then the
   statements
   <pre>
   ...
   <tr> <td align=center><b>d</b></td> <td>Used to output the date of
	 ...
	 <p>For better results it is recommended to use the logengine date
	 formatters. These can be specified using one of the strings
	 "ABSOLUTE", "DATE" and "ISO8601" for specifying {@link
	 com.progdan.logengine.helpers.AbsoluteTimeDateFormat
	 AbsoluteTimeDateFormat}, {@link
	 com.progdan.logengine.helpers.DateTimeDateFormat DateTimeDateFormat}
	 and respectively {@link
	 com.progdan.logengine.helpers.ISO8601DateFormat
