...
import com.progdan.logengine.spi.AppenderAttachable;
import com.progdan.logengine.spi.LoggingEvent;
import com.progdan.logengine.spi.LoggerRepository;
import com.progdan.logengine.helpers.NullEnumeration;
import com.progdan.logengine.helpers.AppenderAttachableImpl;
...
/**
  ...
  * performed on a logger. Internally, whenever LogEngine is asked to
  * produce a Category object, it will instead produce a Logger
  * object. LogEngine 1.2 will <em>never</em> produce Category objects but
  ...
  *  for LogEngine 1.3</a> for a more detailed discussion.
  *
...
public class Category implements AppenderAttachable {
  ...
  */
  ...
  /**
    ...
    {@link com.progdan.logengine.or.ObjectRenderer}. It then proceeds to call all the
  ...
  /**
    ...
    com.progdan.logengine.or.ObjectRenderer}. It proceeds to call all the
    registered appenders in this category and also higher in the
    hierarchy depending on the value of the additivity flag.
  ...
  /**
    ...
    {@link com.progdan.logengine.or.ObjectRenderer}. It
  ...
  */
  ...
  String getResourceBundleString(String key) {
    ...
    // to report errors from within LogEngine.
    if(rb == null) {
 ...
 */
  ...
  */
  ...
  /**
     ...
     <p>Some appenders such as {@link com.progdan.logengine.net.SocketAppender}
