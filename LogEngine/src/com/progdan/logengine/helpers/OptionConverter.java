...
public class OptionConverter {
  ...
  /**
     ...
     character is present, then the default {@link com.progdan.logengine.Level}
  ...
  Level toLevel(String value, Level defaultValue) {
    ...
    try {
      ...
      // toLevel(String, com.progdan.logengine.Level)
      Class[] paramTypes = new Class[] { String.class,
					 com.progdan.logengine.Level.class
                                       };
      ...
      LogLog.warn("class [" + clazz
        + "] is not a subclass of com.progdan.logengine.Level", e);
 ...
 */
  ...
  */
  ...
  /**
     Configure logengine given a URL.

     <p>The url must point to a file or resource which will be interpreted by
     a new instance of a logengine configurator.
     ...
     @param clazz The classname, of the logengine configurator which will parse
     ...
     {@link com.progdan.logengine.xml.DOMConfigurator} is used.
     @param hierarchy The {@link com.progdan.logengine.Hierarchy} to act on.
  ...
  void selectAndConfigure(URL url, String clazz, LoggerRepository hierarchy) {
   ...
   if(clazz == null && filename != null && filename.endsWith(".xml")) {
     clazz = "com.progdan.logengine.xml.DOMConfigurator";
   }
