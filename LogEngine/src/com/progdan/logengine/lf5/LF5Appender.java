...
package com.progdan.logengine.lf5;

import com.progdan.logengine.lf5.util.Resource;
import com.progdan.logengine.lf5.viewer.LogBrokerMonitor;
import com.progdan.logengine.AppenderSkeleton;
import com.progdan.logengine.spi.LocationInfo;
...
public class LF5Appender extends AppenderSkeleton {
  ...
  public void append(LoggingEvent event) {
    // Retrieve the information from the logengine LoggingEvent.
   ...
   * from the <code>com.progdan.logengine.Appender</code> interface.
   */
  public void close() {
  }
