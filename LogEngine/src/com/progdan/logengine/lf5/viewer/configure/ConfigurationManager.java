 ...
 */
package com.progdan.logengine.lf5.viewer.configure;

import com.progdan.logengine.lf5.LogLevel;
import com.progdan.logengine.lf5.LogLevelFormatException;
import com.progdan.logengine.lf5.viewer.LogBrokerMonitor;
import com.progdan.logengine.lf5.viewer.LogTable;
import com.progdan.logengine.lf5.viewer.categoryexplorer.CategoryExplorerModel;
import com.progdan.logengine.lf5.viewer.categoryexplorer.CategoryExplorerTree;
import com.progdan.logengine.lf5.viewer.categoryexplorer.CategoryNode;
import com.progdan.logengine.lf5.viewer.categoryexplorer.CategoryPath;
import com.progdan.logengine.lf5.viewer.LogTableColumn;
import com.progdan.logengine.lf5.viewer.LogTableColumnFormatException;
...
public class ConfigurationManager extends Object {
  ...
  private void processLogLevelColors(Map logLevelMenuItems, Map logLevelColors, StringBuffer xml) {
    ...
    // iterate through the list of log levels being used (LogEngine, jdk1.4, custom levels)
    Iterator it = logLevelMenuItems.keySet().iterator();
    while (it.hasNext()) {
      LogLevel level = (LogLevel) it.next();
