...
/**
    ...
    <ul>
      ...
      com.progdan.logengine.NDC}, location info as if it were logged locally by
      the client.
      ...
      calling the {@link com.progdan.logengine.LogManager#shutdown} method
  ...
  */
  ...
  void connect(InetAddress address, int port) {
    ...
    try {
      ...
      String msg = "Could not connect to remote logengine server at ["
	+address.getHostName()+"].";
