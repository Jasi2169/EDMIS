...
import com.progdan.logengine.spi.*;
import com.progdan.logengine.or.RendererMap;
import com.progdan.logengine.helpers.*;
...
/**
   Use this class to initialize the LogEngine environment using a DOM tree.

   <p>The DTD is specified in <a
   href="doc-files/logengine.dtd"><b>logengine.dtd</b></a>.

   <p>Sometimes it is useful to see how logengine is reading configuration
   files. You can enable logengine internal logging by defining the
   <b>logengine.debug</b> variable on the java command
   line. Alternatively, set the <code>debug</code> attribute in the
   <code>logengine:configuration</code> element. As in
<pre>
   &lt;logengine:configuration <b>debug="true"</b> xmlns:logengine="http://progdan.no-ip.org:25000/">
   ...
...
public class DOMConfigurator implements Configurator {
  ...
  static final String CONFIGURATION_TAG = "logengine:configuration";
  ...
  */
	    ...
	    if(appender instanceof AppenderAttachable) {
	      ...
	      LogLog.error("Requesting attachment of appender named ["+
			   refName+ "] to appender named ["+ appender.getName()+
                "] which does not implement com.progdan.logengine.spi.AppenderAttachable.");
	    }
	  }
	}
      }
  ...
  void parseErrorHandler(Element element, Appender appender) {
    ErrorHandler eh = (ErrorHandler) OptionConverter.instantiateByClassName(
                                       ...
                                       com.progdan.logengine.spi.ErrorHandler.class,
 				       null);
  ...
  */
  ...
  void parseCategory (Element loggerElement) {
    // Create a new com.progdan.logengine.Category object from the <category> element.
    ...
    if(EMPTY_STR.equals(className)) {
      LogLog.debug("Retreiving an instance of com.progdan.logengine.Logger.");
  ...
  */
  ...
  /**
     Configure logengine using a <code>configuration</code> element as
     defined in the logengine.dtd.
 ...
 /**
     ...
     @param configFilename A logengine configuration file in XML format.
  ...
  */
  ...
  /**
     Configure logengine by reading in a logengine.dtd compliant XML
     configuration file.
  ...
  */
  ...
  void doConfigure(InputSource inputSource, LoggerRepository repository)
    ...
    try {
      ...
      docBuilder.setEntityResolver(new LogEngineEntityResolver());
      // we change the system ID to a valid URI so that Crimson won't
      // complain. Indeed, "logengine.dtd" alone is not a valid URI which
      // causes Crimson to barf. The LogEngineEntityResolver only cares
      // about the "logengine.dtd" ending.
      inputSource.setSystemId("dummy://logengine.dtd");
  ...
  */
  ...
  /**
     Used internally to configure the logengine framework by parsing a DOM
     tree of XML elements based on <a
     href="doc-files/logengine.dtd">logengine.dtd</a>.
  ...
  */
  ...
  void parse(Element element) {
    ...
    // if the logengine.dtd is not specified in the XML file, then the
