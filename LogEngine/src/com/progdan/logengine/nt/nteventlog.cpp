...
#include "org_apache_logengine_Priority.h"
#include "org_apache_logengine_nt_NTEventLogAppender.h"
#include <windows.h>
...
/*
 * Convert logengine Priority to an EventLog category. Each category is
...
/*
 * Convert logengine Priority to an EventLog type. The logengine package
...
WORD getType(jint priority) {
  ...
  switch (priority) {
  case com_progdan_logengine_Priority_FATAL_INT:
  case com_progdan_logengine_Priority_ERROR_INT:
    ret_val = EVENTLOG_ERROR_TYPE;
    break;
  case com_progdan_logengine_Priority_WARN_INT:
    ret_val = EVENTLOG_WARNING_TYPE;
    break;
  case com_progdan_logengine_Priority_INFO_INT:
  case com_progdan_logengine_Priority_DEBUG_INT:
  default:
...
/*
 * Class:     com.progdan.logengine.nt.NTEventLogAppender
 * Method:    registerEventSource
 * Signature: (Ljava/lang/String;Ljava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_progdan_logengine_nt_NTEventLogAppender_registerEventSource(
...
/*
 * Class:     com_progdan_logengine_nt_NTEventLogAppender
 * Method:    reportEvent
 * Signature: (ILjava/lang/String;I)V
 */
JNIEXPORT void JNICALL Java_com_progdan_logengine_nt_NTEventLogAppender_reportEvent(
  ...
  if (handle == 0) {
    ...
    handle = (jint)RegisterEventSource(NULL, "LogEngine");
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_progdan_logengine_nt_NTEventLogAppender_deregisterEventSource(
JNIEnv *env,
jobject java_this,
jint handle)
{
