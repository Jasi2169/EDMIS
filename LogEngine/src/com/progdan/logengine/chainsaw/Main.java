    ...
    extends JFrame
{
    ...
    /** initialise logengine **/
    private static void initLog4J() {
        final Properties props = new Properties();
        props.setProperty("logengine.rootLogger", "DEBUG, A1");
        props.setProperty("logengine.appender.A1",
                          "com.progdan.logengine.ConsoleAppender");
        props.setProperty("logengine.appender.A1.layout",
                          "com.progdan.logengine.TTCCLayout");
