...
package com.progdan.logengine.chainsaw;
    ...
    extends DefaultHandler
{
    ...
    private static final String TAG_EVENT = "logengine:event";
    /** represents the message tag **/
    private static final String TAG_MESSAGE = "logengine:message";
    /** represents the ndc tag **/
    private static final String TAG_NDC = "logengine:NDC";
    /** represents the throwable tag **/
    private static final String TAG_THROWABLE = "logengine:throwable";
    /** represents the location info tag **/
    private static final String TAG_LOCATION_INFO = "logengine:locationInfo";
