...
/**
   ...
   is created. This instance is passed around to the different logengine
   components.

   <p>This class is of concern to those wishing to extend logengine.
...
public class LoggingEvent implements java.io.Serializable {
  ...
  /** The application supplied message rendered through the logengine
