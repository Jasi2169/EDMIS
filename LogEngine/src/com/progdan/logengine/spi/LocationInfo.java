  ...
  /**
     ...
     expect the Throwable <code>t</code>, to be in the format
       ...
       <pre>
        java.lang.Throwable
        ...
          at com.progdan.logengine.PatternLayout.format(PatternLayout.java:413)
          at com.progdan.logengine.FileAppender.doAppend(FileAppender.java:183)
        at com.progdan.logengine.Category.callAppenders(Category.java:131)
        at com.progdan.logengine.Category.log(Category.java:512)
    ...
    */
	...
	sw.getBuffer().setLength(0);
      ...
      // containing "com.progdan.logengine.Category." should be printed just
      // before the caller.
