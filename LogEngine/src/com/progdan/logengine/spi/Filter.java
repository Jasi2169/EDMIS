...
/**
   ...
   event filtering. Note that {@link com.progdan.logengine.Category} and {@link
   com.progdan.logengine.AppenderSkeleton}, the parent class of all standard
   ...
   <p>The philosophy of LogEngine filters is largely inspired from the
   Linux ipchains.

   <p>Note that filtering is only supported by the {@link
   com.progdan.logengine.xml.DOMConfigurator DOMConfigurator}. The {@link
   com.progdan.logengine.PropertyConfigurator PropertyConfigurator} does not
   support filters.
