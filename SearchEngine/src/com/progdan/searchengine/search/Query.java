...
/** The abstract base class for queries.
    ...
    <li> {@link FuzzyQuery}
    <li> {@link RangeQuery}
    <li> {@link com.progdan.searchengine.search.spans.SpanQuery}
    </ul>
    <p>A parser for queries is contained in:
    <ul>
    <li>{@link com.progdan.searchengine.queryParser.QueryParser QueryParser}
    </ul>
*/
public abstract class Query implements java.io.Serializable, Cloneable {
   ...
   * {@link com.progdan.searchengine.queryParser.QueryParser QueryParser}
