package com.progdan.searchengine.store;
...
import com.progdan.searchengine.util.Constants;

/**
 * Straightforward implementation of {@link Directory} as a directory of files.
 * <p>If the system property 'disableSearchEngineLocks' has the String value of
...
public final class FSDirectory extends Directory {
  ...
  private static final boolean DISABLE_LOCKS =
      Boolean.getBoolean("disableSearchEngineLocks") || Constants.JAVA_1_1;

  /**
   * Directory specified by <code>com.progdan.searchengine.lockdir</code>
   * or <code>java.io.tmpdir</code> system property
   */
  public static final String LOCK_DIR =
    System.getProperty("com.progdan.searchengine.lockdir",
   ...
   *
   * <p>In JDK 1.1 or if system property <I>disableSearchEngineLocks</I> is the
   ...
   * using SearchEngine on read-only medium, such as CD-ROM.
   *
