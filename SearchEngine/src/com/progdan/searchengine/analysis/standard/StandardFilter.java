package com.progdan.searchengine.analysis.standard;
...
import com.progdan.searchengine.analysis.*;
...
public final class StandardFilter extends TokenFilter
   ...
   */
  public final com.progdan.searchengine.analysis.Token next() throws java.io.IOException {
    com.progdan.searchengine.analysis.Token t = input.next();
	...
	(text.endsWith("'s") || text.endsWith("'S"))) {
      return new com.progdan.searchengine.analysis.Token
