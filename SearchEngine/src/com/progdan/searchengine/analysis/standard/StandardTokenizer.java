 ...
 */
public class StandardTokenizer extends com.progdan.searchengine.analysis.Tokenizer implements StandardTokenizerConstants {
 ...
 */
  final public com.progdan.searchengine.analysis.Token next() throws ParseException, IOException {
  Token token = null;
    ...
    default:
      ...
      if (token.kind == EOF) {
        ...
        {if (true) return
          new com.progdan.searchengine.analysis.Token(token.image,
