package com.progdan.searchengine.index;
...
import com.progdan.searchengine.store.Directory;
import com.progdan.searchengine.store.RAMDirectory;
import com.progdan.searchengine.store.FSDirectory;
import com.progdan.searchengine.store.Lock;
import com.progdan.searchengine.store.InputStream;
import com.progdan.searchengine.store.OutputStream;
import com.progdan.searchengine.search.Similarity;
import com.progdan.searchengine.document.Document;
import com.progdan.searchengine.analysis.Analyzer;
...
public class IndexWriter {
  ...
  /**
   * Default value is 1000.  Use <code>com.progdan.searchengine.writeLockTimeout</code>
   * system property to override.
   */
  public static long WRITE_LOCK_TIMEOUT =
    Integer.parseInt(System.getProperty("com.progdan.searchengine.writeLockTimeout",
      "1000"));

  /**
   * Default value is 10000.  Use <code>com.progdan.searchengine.commitLockTimeout</code>
   * system property to override.
   */
  public static long COMMIT_LOCK_TIMEOUT =
    Integer.parseInt(System.getProperty("com.progdan.searchengine.commitLockTimeout",
      "10000"));
  ...
  /**
   * Default value is 10.  Use <code>com.progdan.searchengine.mergeFactor</code>
   * system property to override.
   */
  public static final int DEFAULT_MERGE_FACTOR =
    Integer.parseInt(System.getProperty("com.progdan.searchengine.mergeFactor",
      "10"));

  /**
   * Default value is 10.  Use <code>com.progdan.searchengine.minMergeDocs</code>
   * system property to override.
   */
  public static final int DEFAULT_MIN_MERGE_DOCS =
    Integer.parseInt(System.getProperty("com.progdan.searchengine.minMergeDocs",
      "10"));

  /**
   * Default value is {@link Integer#MAX_VALUE}.
   * Use <code>com.progdan.searchengine.maxMergeDocs</code> system property to override.
   */
  public static final int DEFAULT_MAX_MERGE_DOCS =
    Integer.parseInt(System.getProperty("com.progdan.searchengine.maxMergeDocs",
      String.valueOf(Integer.MAX_VALUE)));

  /**
   * Default value is 10000.  Use <code>com.progdan.searchengine.maxFieldLength</code>
   * system property to override.
   */
  public static final int DEFAULT_MAX_FIELD_LENGTH =
    Integer.parseInt(System.getProperty("com.progdan.searchengine.maxFieldLength",
      "10000"));
  ...
  */
   ...
   * Since Documents are merged in a {@link com.progdan.searchengine.store.RAMDirectory},
