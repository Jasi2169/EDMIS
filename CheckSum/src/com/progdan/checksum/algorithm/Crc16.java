...
public class Crc16 extends AbstractChecksum {
    ...
    /*
        ...
        http://www.mit.edu/afs/net.mit.edu/project/radius/3.6B/src/cache.c

          Polynomial for this CRC is x^16 + x^15 + x^2 + 1
        ...
        => parameter for method buildTable is 0xA001.
    */

    /*
        The following source build values for the CRC-16 lookup table,
        because it is much faster to look in a precompiled table!


    public static final int[] buildTable(int poly) {
    ...
    public static void main(String[] args) throws Exception {
      ...
      int[] table = buildTable(0xA001);
      int len=256;
      int i=0;
      while (--len >= 0) {
        System.out.print("0x"+Service.hexformat((long)table[i],4).toUpperCase()+",");
