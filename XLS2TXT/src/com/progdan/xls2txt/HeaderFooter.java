 ...
 */
public final class HeaderFooter extends com.progdan.xls2txt.biff.HeaderFooter
{
  /**
   * The contents - a simple wrapper around a string buffer
   */
  public static class Contents extends com.progdan.xls2txt.biff.HeaderFooter.Contents
  {
    /**
     * The constructor
     */
   ...
   */
  protected com.progdan.xls2txt.biff.HeaderFooter.Contents createContents()
  {
    return new Contents();
  }
   ...
   * Creates internal class of the appropriate type
   */
  protected com.progdan.xls2txt.biff.HeaderFooter.Contents createContents(String s)
  {
   ...
   * Creates internal class of the appropriate type
   */
  protected com.progdan.xls2txt.biff.HeaderFooter.Contents
    createContents(com.progdan.xls2txt.biff.HeaderFooter.Contents c)
  {
