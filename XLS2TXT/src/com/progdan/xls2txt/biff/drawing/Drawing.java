...
import com.progdan.xls2txt.biff.ByteData;
...
import com.progdan.xls2txt.write.biff.File;
...
public class Drawing
{
   ...
   */
  public Drawing(MsoDrawingRecord mso, ObjRecord obj, DrawingData dd,
                 DrawingGroup dg)
  {
    drawingGroup = dg;
  ...
  public EscherContainer getSpContainer()
  {
    ...
    Sp sp = new Sp(type, 1024 + objectId, 2560);
    spContainer.add(sp);
    Opt opt = new Opt();
