...
import com.progdan.xls2txt.biff.RangeImpl;
...
import com.progdan.xls2txt.read.biff.WorkbookParser;
import com.progdan.xls2txt.biff.formula.ExternalSheet;
import com.progdan.xls2txt.format.Colour;
import com.progdan.xls2txt.biff.drawing.DrawingGroup;
  ...
  implements ExternalSheet, WorkbookMethods
{
                              ...
                              WorkbookSettings ws) throws IOException
  {
    ...
    if (wp.getExternalSheetRecord() != null)
    {
      ...
      com.progdan.xls2txt.read.biff.SupbookRecord[] readsr = wp.getSupbookRecords();
    ...
    {
      com.progdan.xls2txt.read.biff.NameRecord[] na = wp.getNameRecords();
  ...
  public void write() throws IOException
  {
    ...
    // byte[] arbdata = new byte[0];
    //ArbitraryRecord ar = new ArbitraryRecord(com.progdan.xls2txt.biff.Type.U1C0, arbdata);
    //    outputFile.write(ar);
   ...
   */
  public com.progdan.xls2txt.read.biff.BOFRecord getWorkbookBof()
  {
    return null;
  }
