...
import com.progdan.xls2txt.BooleanCell;
import com.progdan.xls2txt.Hyperlink;
import com.progdan.xls2txt.Range;
import com.progdan.xls2txt.SheetSettings;
import com.progdan.xls2txt.WorkbookSettings;
import com.progdan.xls2txt.CellView;
import com.progdan.xls2txt.HeaderFooter;
import com.progdan.xls2txt.format.CellFormat;
import com.progdan.xls2txt.format.Border;
import com.progdan.xls2txt.format.BorderLineStyle;
import com.progdan.xls2txt.format.PageOrientation;
import com.progdan.xls2txt.format.PaperSize;
import com.progdan.xls2txt.write.Blank;
...
import com.progdan.xls2txt.write.Boolean;
...
import com.progdan.xls2txt.biff.EmptyCell;
import com.progdan.xls2txt.biff.XFRecord;
import com.progdan.xls2txt.biff.NumFormatRecordsException;
import com.progdan.xls2txt.biff.FormulaData;
import com.progdan.xls2txt.biff.SheetRangeImpl;
import com.progdan.xls2txt.biff.IndexMapping;
import com.progdan.xls2txt.biff.WorkspaceInformationRecord;

import com.progdan.xls2txt.biff.drawing.Chart;
import com.progdan.xls2txt.biff.drawing.Drawing;
...
class WritableSheetImpl implements WritableSheet
{
  ...
  /**
   * Drawings modified flag.  Set to true if the drawins list has
   * been modified
   */
   ...
   * @exception com.progdan.xls2txt.write.biff.RowsExceededException
   */
  ...
  void copy(Sheet s)
  {
    ...
    com.progdan.xls2txt.read.biff.SheetImpl si = (com.progdan.xls2txt.read.biff.SheetImpl) s;
    com.progdan.xls2txt.read.biff.ColumnInfoRecord[] readCirs = si.getColumnInfos();

    for (int i = 0 ; i < readCirs.length; i++)
    {
      com.progdan.xls2txt.read.biff.ColumnInfoRecord rcir = readCirs[i];
    ...
    try
    {
      com.progdan.xls2txt.read.biff.RowRecord[] rowprops  = si.getRowProperties();
   ...
   * @exception com.progdan.xls2txt.write..WriteException
   * @exception com.progdan.xls2txt.write.biff.RowsExceededException
   */
