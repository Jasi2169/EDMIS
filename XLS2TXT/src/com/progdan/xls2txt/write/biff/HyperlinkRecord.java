...
import com.progdan.xls2txt.biff.CellReferenceHelper;
...
public class HyperlinkRecord extends WritableRecordData
{
  ...
  protected HyperlinkRecord(Hyperlink h, WritableSheet s)
  {
    ...
    Assert.verify(h instanceof com.progdan.xls2txt.read.biff.HyperlinkRecord);

    com.progdan.xls2txt.read.biff.HyperlinkRecord hl = (com.progdan.xls2txt.read.biff.HyperlinkRecord) h;
