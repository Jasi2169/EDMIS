...
import com.progdan.xls2txt.biff.drawing.ObjRecord;
import com.progdan.xls2txt.biff.drawing.MsoDrawingRecord;
import com.progdan.xls2txt.biff.drawing.Drawing;
import com.progdan.xls2txt.biff.drawing.DrawingData;
    ...
    while (cont)
    {
      ...
      else if (r.getType() == Type.OBJ)
      {
        ...
        else if (objRecord.getType() != ObjRecord.CHART)
        {
          msoRecord = null;
          objRecord = null;
          workbook.getDrawingGroup().setDrawingsOmitted();
        }
      }
