...
package com.progdan.xls2txt.common;
...
public abstract class Logger
{
  ...
  private synchronized static void initializeLogger()
  {
    ...
    if (loggerName == null)
    {
      ...
      loggerName = com.progdan.xls2txt.common.log.LoggerName.NAME;
    }
    ...
    {
      logger = new com.progdan.xls2txt.common.log.SimpleLogger();
   ...
   * primarily for backwards support of the com.progdan.xls2txt.nowarnings property, and
